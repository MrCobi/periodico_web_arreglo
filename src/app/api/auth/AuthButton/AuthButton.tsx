  ...
  if (session) {
    return (
      <div style={{ position: "relative" }}>
        <button
          onClick={handleMenu}
          className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-[#21262C] transition-colors duration-200"
        >
          <div className="flex items-center gap-2">
            {/* Avatar del usuario */}
            <div className="w-8 h-8 rounded-full overflow-hidden">
              <Image
                src={session.user?.image || "/images/default_periodico.jpg"}
