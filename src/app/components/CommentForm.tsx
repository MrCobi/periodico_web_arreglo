...
export default function CommentForm({
  ...
  const isContentValid = content.trim().length >= 3 && content.trim().length <= 500;
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-8">
      ...
      <button
        ...
        className={`bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 ${isSubmitting || !isContentValid ? "opacity-50 cursor-not-allowed" : ""
          }`}
      >
